  ...
  return (
    <section className="max-w-7xl mx-auto mt-28">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[500px] text-l"> Generate imaginative and visually stunning images through AI image generator and share them with the community </p>
      </div>
      <form className="mt-12 max-w-3xl " onSubmit={handleSubmit}>
        ...
        <div className="flex gap-16 ">
          <button
            ...
            className="mt-5 text-white bg-green-700 font-medium rounded-md text-sm w-full sm:w-auto px-4 py-2 text-center hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:ring-opacity-50"
          >
